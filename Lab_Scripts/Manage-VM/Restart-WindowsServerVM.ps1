...
$participant_number = [convert]::ToInt32((Read-Host "Die Windows Server VM welches Teilnehmers soll neugestartet werden?"), 10)
$participant_number = "{0:00}" -f $participant_number

$VM_Name="winserver.lab$participant_number.net"
